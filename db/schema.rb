...
ActiveRecord::Schema.define(version: 20170615211150) do
  ...
  create_table "responses", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["answer_choice_id", "respondent_id"], name: "index_responses_on_answer_choice_id_and_respondent_id", using: :btree
  end
